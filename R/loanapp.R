#' loanapp
#'
#' Data from wooldRidge package loads lazily. Type data(loanapp) into the console.
#'
#' @docType data
#'
#' @usage data(loanapp)
...
#'  \item{hrat}{housing exp, percent total inc}
#'  \item{obrat}{other oblgs,  percent total inc}
...
#'  \item{min30}{=1 if minority pop. > 30percent}
