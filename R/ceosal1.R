#' ceosal1
#'
#' Data from wooldRidge package loads lazily. Type data(ceosal1) into the console.
#'
#' @docType data
#'
#' @usage data(ceosal1)
...
#'  \item{pcsalary}{percent change salary, 89-90}
#'  \item{sales}{1990 firm sales, millions $}
#'  \item{roe}{return on equity, 88-90 avg}
#'  \item{pcroe}{percent change roe, 88-90}
