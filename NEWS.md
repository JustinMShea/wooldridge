...
Updated vignette to remove *tidy = TRUE* markdown chunk parameters as breaking changes appear to have been made and, which now require the installion of a seperate package. I like to keep dependencies to a minimal for this reason.
