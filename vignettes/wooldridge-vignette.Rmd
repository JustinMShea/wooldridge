...
In addition to this vignette, please see the **Additional Resources** section on using R for Econometrics. It contains information on the excellent and in depth _"Using R for Introductory Econometrics"_ by Florian Hess, written to compliment the Wooldridge text as well.
