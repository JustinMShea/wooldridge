...
## Chapter 15: Advanced Panel Data Methods
...
> "The $t$ statistic on $long(land)$ is over nine in absolute value, which verifies Romer's assertion that smaller countries are more open. The fact that $log(pcinc)$ is so insignificant in this regression is irrelevant."
