...
> "Using the 526 observations on workers in 'wage1', we include educ(years of education),
exper(years of labor market experience), and tenure(years with the current employer) in an
equation explain log(wage)."
...
$$price = \beta_0 + \beta_1log(nox) + \beta_2log(dist) + \beta_3rooms + \beta_4rooms^2 + \beta_5stratio + \mu$$
```{r}
