...
index(FYFRGDA188S) <- as.yearmon(index(FYFRGDA188S)) + 11/12
 # Rename and update column names
outlays <- FYFRGDA188S
...
getSymbols("FYONGDA188S", src = "FRED")
 # Lets move the index from Jan 1st to Dec 30th/31st
index(FYONGDA188S) <- as.yearmon(index(FYONGDA188S)) + 11/12
 # Rename and update column names
