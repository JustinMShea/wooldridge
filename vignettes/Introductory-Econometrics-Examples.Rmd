...
Plot the coefficients, representing the impact of each variable on $log($`scrape`$)$ for a quick comparison. As you can observe, for some variables, the confidence intervals are wide.
