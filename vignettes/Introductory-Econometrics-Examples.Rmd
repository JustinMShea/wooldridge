...
```{r, tidy=TRUE}
plot(y = wage1$lwage, x = wage1$educ, main = "A Log Wage Equation", col = "darkgreen", 
     pch = 21, bg = "lightgrey", cex=1.25,xlab = "years of education", 
     ylab = "log of average hourly wages",  xaxt="n", frame = FALSE)
axis(side = 1, at = c(0,6,12,18))
...
```{r}
barplot(summary(hourly_wage_model)$coefficients[-1, "t value"], 
        ylab = "t statistic", main = "t statistics of Hourly Wage Equation")
```
...
plot(y = hprice2$lprice, x = hprice2$rooms, xaxt="n", frame = FALSE,
     main = "Effects of Pollution on Housing Prices", 
     xlab = "Rooms", ylab = "Log(selling price)")
