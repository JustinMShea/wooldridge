...
```{r, results='asis', echo=FALSE, warning=FALSE, message=FALSE}
stargazer(type = "html",housing_standard,  single.row = TRUE, header = FALSE, digits=5)
```
...
stargazer(type = "html",housing_standard, housing_interactive, single.row = TRUE, header = FALSE, digits=5)
```
